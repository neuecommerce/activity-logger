...
class ActivityLoggerService implements ActivityLoggerServiceInterface
{
    ...
    public function __construct(
        private ActivityLoggerInterface $model,
    ) {
    }
    ...
    {
        return $this->log(ActivityLoggerType::CREATED, $title, $description);
    }
    ...
    public function updated(string $title, string $description = ''): ActivityLoggerInterface
    {
        ...
        return $this->log(ActivityLoggerType::UPDATED, $title, $description);
    }

    public function deleted(string $title, string $description = ''): ActivityLoggerInterface
    {
        return $this->log(ActivityLoggerType::DELETED, $title, $description);
    }

    public function restored(string $title, string $description = ''): ActivityLoggerInterface
    {
        return $this->log(ActivityLoggerType::RESTORED, $title, $description);
    }

    public function viewed(string $title, string $description = ''): ActivityLoggerInterface
    {
        return $this->log(ActivityLoggerType::VIEWED, $title, $description);
    }
